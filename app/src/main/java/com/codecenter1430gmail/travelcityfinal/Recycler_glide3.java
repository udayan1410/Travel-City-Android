...
public class Recycler_glide3 extends RecyclerView.Adapter<Recycler_glide3.ViewHolder> {
    ...
    public Recycler_glide3(Context mcontext, ArrayList<String> mNames, ArrayList<String> mImagepath) {
        this.mcontext = mcontext;
        this.mNames = mNames;
        this.mImagepath = mImagepath;

    }
    public Recycler_glide3()
    {
