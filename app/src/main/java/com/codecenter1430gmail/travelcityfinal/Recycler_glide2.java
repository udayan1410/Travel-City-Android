...
public class Recycler_glide2 extends RecyclerView.Adapter<Recycler_glide2.ViewHolder> {
    ...
    public Recycler_glide2(Context mcontext, ArrayList<String> mNames, ArrayList<String> mImagepath) {
        this.mcontext = mcontext;
        this.mNames = mNames;
        this.mImagepath = mImagepath;

    }
    public Recycler_glide2()
    {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        //Glide.with(mcontext).load(mImagepath.get(position)).thumbnail(Glide.with(mcontext).load(R.drawable.loading_small)).error(R.mipmap.no_data).crossFade().into(holder.image);
