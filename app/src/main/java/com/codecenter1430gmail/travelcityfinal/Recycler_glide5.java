...
public class Recycler_glide5 extends RecyclerView.Adapter<Recycler_glide5.ViewHolder> {
    ...
    public Recycler_glide5(Context mcontext, ArrayList<String> mNames, ArrayList<String> mImagepath) {
        this.mcontext = mcontext;
        this.mNames = mNames;
        this.mImagepath = mImagepath;

    }
    public Recycler_glide5()
    {
